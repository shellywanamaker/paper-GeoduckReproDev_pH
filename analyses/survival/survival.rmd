...
surv_data <- read_xlsx("../../data/survival/Broodstock_survival_20181112-20190221.xlsx", sheet = "Rdata")
...
ggsurvplot(survfit(surv ~ pCO2, surv_data), risk.table = FALSE, pval = FALSE, conf.int = TRUE, palette = alpha(c("#00BFC4", "#F8766D"),c(0.7,0.5)), break.x.by = 10, xlim = c(1,93) , xlab = "Time (days)", legend.title = "treatment", legend.labs = c("ambient pCO2 (839 uatm)", "high pCO2 (5430 uatm)"))
dev.off()
```
